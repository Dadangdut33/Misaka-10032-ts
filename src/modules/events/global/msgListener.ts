...
module.exports = class extends BotEvent {
	...
	crosspost = (message: Message) => {
		try {
			...
			console.log(`[${new Date().toLocaleString()}] [ERROR] [Crosspost]`);
			console.log(error);
		}
	};
	...
	checkGeh = (message: Message) => {
		try {
			...
			console.log(`[${new Date().toLocaleString()}] [ERROR] [Geh]`);
			console.log(error);
		}
	};
	...
	detectHaiku = async (message: Message) => {
		try {
			...
			console.log(`[${new Date().toLocaleString()}] [ERROR] [Haiku]`);
			console.log(error);
		}
	};
	...
	detectAnimeSearch = async (message: Message) => {
		try {
			...
			console.log(`[${new Date().toLocaleString()}] [ERROR] [AnimeSearch]`);
			console.log(error);
		}
	};
	...
	detectMangaSearch = async (message: Message) => {
		try {
			...
			console.log(`[${new Date().toLocaleString()}] [ERROR] [MangaSearch]`);
			console.log(error);
		}
	};
	...
	botIsMentioned = (client: Client, message: Message) => {
		try {
			...
			console.log(`[${new Date().toLocaleString()}] [ERROR] [BotMention]`);
			console.log(error);
		}
	};

	replaceFacebookMobileLink = (message: Message) => {
		try {
			if (message.content.startsWith(prefix) || message.channel.type === "DM") return;

			// replace m.facebook.com with www.facebook.com
			if (message.content.includes("m.facebook.com")) message.reply(message.content.replace(/m.facebook.com/g, "www.facebook.com"));
		} catch (error) {
			console.log(`[${new Date().toLocaleString()}] [ERROR] [FacebookReplace]`);
			console.log(error);
		}
	};
	...
	run(client: Client, message: Message) {
		...
		this.replaceFacebookMobileLink(message);
	}
};
